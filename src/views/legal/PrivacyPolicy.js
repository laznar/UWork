  ...
  return (
    <div className="container custom-container">
      <Card>
        ...
        <h2>Interpretaciones y Definiciones</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to UWork.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to UWork, accessible from
              <a
                href="https://uwork.surge.sh"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://uwork.surge.sh
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>Correo: laznar@uninorte.edu.co</p>
          </li>
          <li>
            <p>Teléfono: +573012197199</p>
          </li>
        </ul>
      </Card>
    </div>
