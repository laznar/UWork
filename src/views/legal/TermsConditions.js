  ...
  return (
    <div className="container custom-container">
      <Card>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to https://uwork.surge.sh.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to https://uwork.surge.sh,
              accessible from{' '}
              <a href="UWork" rel="external nofollow noopener" target="_blank">
                UWork
              </a>
            </p>
          </li>
        ...
        <ul>
          <li>
            <p>By email: laznar@uninorte.edu.co</p>
          </li>
          <li>
            <p>By phone number: +573012197199</p>
          </li>
        </ul>
      </Card>
    </div>
